...
#
# Runs ON the broker host (broker-host), on a timer. Resolves the newest published release,
...
#
# Pull-based on purpose: broker-host has no public ingress, so a push-based CD would mean
