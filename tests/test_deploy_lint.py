...
def test_healthcheck_does_not_hardcode_loopback():
    ...
    broker-host happened to publish 127.0.0.1:8765 and a bare TCP connect cannot tell which
...
def test_the_worker_host_is_not_a_systemd_hostname_specifier():
    """%l is the machine hostname (LAPTOP-HOST); the worker's identity to the broker is
